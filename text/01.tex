...
\subsection{Vysvětlete pojem základní zdroj zpráv, čím je určen a jaké jsou jeho vlastnosti}
Jedná se o diskrétní prvek, jelikož k popisu je použit konečný počet charakteristických prvků.
...
Vlastnosti základního zdroje se dělí na statistické a dynamické.\\
\textbf{Statistické}
\begin{itemize}
        \item Množství informace
        \item Entropie zdroje
        \item Maximální entropie
        \item Relativní entropie
        \item Redundance
\end{itemize}
\textbf{Dynamické}
\begin{itemize}
        \item Informační rychlost základního zdroje
        \item Modulační rychlost zdroje
\end{itemize}
...
Důvodem je nedostatek signálových stavů vzhledem k počtu symbolů základního zdroje. Přizpůsobením zdroje na další přenost je použit pomocný zdroj, který má definován vyhovující počet symbolů. Pomocný zdroj je určen množinou X = ${x_i}$.
...
\subsection{Jaké jsou statistické a dynamické charakteristiky přizpůsobeného zdroje zpráv}
\textbf{Statistické}
\begin{itemize}
    \item Entropie přizpůsobeného zdroje
    \item Max entropie přizpůsobeného zdroje
...
Modulační rychlost vyjadřuje počet změn prvků za jednotku času. Jednotkou je Baud [Bd].
